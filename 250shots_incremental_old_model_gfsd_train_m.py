...
model.train(data="250shots_incremental_vedai.yaml",
            ...
            name='250shots_normal_incremental_vedai2dvvedai',
            # pretrained=False,
            optimizer='SGD',
            lr0 = 0.005,
            seed=0,
...
##恢复
# model = YOLO_m("/root/FoRA/incremental_old_model_gfsd_train_m/250shots_normal_incremental_vedai2dvvedai/weights/best.pt")
# model.model.modal = 'both'
# model.train(data="250shots_incremental_vedai.yaml",
#             #incremental_yaml = "yolov8h_incremental_lma_multi_head_ScaleConvFuse.yaml",#增量的模型
#             epochs=200,
...
#           project="incremental_old_model_gfsd_train_m",
#           name='250shots_test_normal_incremental_vedai2dvvedai',
#           imgsz=2500,
#           batch=20,
#           device=[0]
#           )