...
model.train(data="/root/FoRA/data_yaml/allvedai.yaml",
            epochs=50,
            patience=30,
            batch=2,
            imgsz=800,
            ...
            name='full_allvedai_tfa',
            optimizer='SGD',
            seed=0,
            freeze=55,
            )

model = YOLO_m("/root/FoRA/incremental_exp/incremental_old_model_work_dir/full_allvedai_tfa/weights/best.pt")
model.model.modal = 'both'
model.val(data="/root/FoRA/data_yaml/incremental_vedai2dvvedai.yaml",
          project="incremental_old_model_work_dir",
          name='full_allvedai_tfa_test',
          imgsz=800,
          batch=20,
          device=[0]
          )