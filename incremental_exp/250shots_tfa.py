...
model.train(data="/root/FoRA/data_yaml/250shots_incremental_vedai.yaml",
            ...
            name='250shots_tfa_with_focal_loss',
            optimizer='SGD',
            seed=0,
            freeze=55,
            )

model = YOLO_m("/root/FoRA/incremental_exp/incremental_old_model_work_dir/250shots_tfa_with_focal_loss/weights/best.pt")
model.model.modal = 'both'
model.val(data="/root/FoRA/data_yaml/incremental_vedai2dvvedai.yaml",
          project="incremental_old_model_work_dir",
          name='250shots_tfa_with_focal_loss_test',
          imgsz=800,
          batch=20,
          device=[0]
          )